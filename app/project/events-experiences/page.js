...
export default function EventsExperiences() {
  ...
  return (
    <div className="font-sans relative min-h-screen overflow-x-hidden">
      ...
      >
        ...
        <div className="hidden sm:flex sm:justify-start relative">
          ...
          {dropdownOpen && (
            <div
              ...
              onMouseLeave={() => setDropdownOpen(false)}
            >
              <Link href="/project/interiors" className="block px-4 py-2 text-sm text-white hover:bg-white hover:text-grey">
                Interiors
              </Link>
              <Link href="/project/buy-stay" className="block px-4 py-2 text-sm text-white hover:bg-white hover:text-grey">
                Buy & Stay
              </Link>
              <Link href="/project/events-experiences" className="block px-4 py-2 text-sm text-white hover:bg-white hover:text-grey">
                Events & Experiences
              </Link>
            </div>
          )}
        ...
        {menuOpen && (
          <div className="absolute top-full left-0 w-full bg-grey flex flex-col items-center py-4 border-t border-gray-1000 sm:hidden animate-slide-down">
            <div
              className="py-2 text-sm text-white hover:underline cursor-pointer flex items-center justify-center w-full"
            ...
            {mobileDropdownOpen && (
              <div className="flex flex-col items-center w-full">
                <a
                  ...
                  className="py-2 text-sm text-white hover:underline pl-4"
      ...
      <div className="fixed right-0 top-1/2 transform -translate-y-1/2 z-30 flex flex-col space-y-0">
        {/* Toggle Button */}
        <button
        ...
        {contactBarOpen && (
          <div
            onMouseEnter={() => setShowForm(true)}
            onMouseLeave={() => setShowForm(false)}
            className={`fixed right-0 top-1/2 transform -translate-y-1/2 z-40 bg-white shadow-lg p-6 rounded-l-lg w-80 transition-transform duration-300 ${
