...
export default function VermontModern() {
  ...
  const handleContactSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_0hzoxjk',
      {
        ...
        hear_about_us: 'Vermont Modern Page Floating Contact Form',
        message: contactFormData.message,
      },
      'VFpd616Sj6d9RlzWA'
    ).then((result) => {
      console.log('Vermont Modern page floating contact email sent successfully:', result.text);
      ...
      console.error('Error sending Vermont Modern page floating contact email:', error.text);
