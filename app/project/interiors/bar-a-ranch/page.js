  ...
  const handleContactSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_0hzoxjk',
      {
        ...
        hear_about_us: 'Bar A Ranch Page Floating Contact Form',
        message: contactFormData.message,
      },
      'VFpd616Sj6d9RlzWA'
    ).then((result) => {
      console.log('Bar A Ranch page floating contact email sent successfully:', result.text);
      ...
      console.error('Error sending Bar A Ranch page floating contact email:', error.text);
