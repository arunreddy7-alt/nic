  ...
  const handleContactSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_0hzoxjk',
      {
        ...
        hear_about_us: 'About Page Floating Contact Form',
        message: contactFormData.message,
      },
      'VFpd616Sj6d9RlzWA'
    ).then((result) => {
      console.log('About page floating contact email sent successfully:', result.text);
      ...
      console.error('Error sending about page floating contact email:', error.text);
