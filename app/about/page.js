      ...
      <section className="min-h-screen bg-white pt-24 px-6 sm:px-10 md:px-16 lg:px-24 xl:px-32">
        <div className="mx-auto w-full max-w-[2200px] grid grid-cols-1 md:grid-cols-[1.5fr_1fr] gap-10 h-[160vh]">
          ...
          <div className="text-black leading-7 md:sticky md:top-28 -ml-10 md:-ml-23 transform translate-x-13 translate-y-19">
            ...
            As NICARA grew, we expanded into handpicked properties for purchase<br/> and stay, helping clients discover spaces — from residences to holiday<br/> homes — that resonate with their lifestyle and taste. Today, NICARA is a<br/> celebration of living elegantly, effortlessly, and intentionally, turning spaces<br/> into stories, moments into memories, and dreams in            </p>
          </div>
        </div>
        ...
        <div className="text-black leading-7 md:sticky md:top-28 -ml-10 md:-ml-23 transform translate-x-200 -translate-y-225">
            ...
            <p className="text-xs md:text-sm mb-4">
            Nishanth is the co-founder of NICARA, holding a Master’s in Design<br/> from London and an MBA from Bangalore. He is inspired by the idea<br/> of turning spaces into experiences, creating interiors that are<br/> luxurious, warm, playful, and deeply personal.</p>
             <p className="text-xs md:text-sm mb-4">
            ...
            <p className="text-xs md:text-sm">
            At NICARA, Sriniketh’s ability to balance design vision with flawless<br/> execution makes him an integral force behind the studio’s commitment<br/> to luxury, reliability, and refined living.</p>
            </div>
            </section>
