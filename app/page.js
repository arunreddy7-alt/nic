  ...
  return (
    <div className="font-sans relative min-h-screen bg-white overflow-x-hidden">
      ...
      <section id="about" className="min-h-screen bg-white pt-24 px-4 sm:px-10 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="text-black leading-7 md:sticky md:top-28 pl-0 sm:pl-4 md:pl-0 -ml-0 md:-ml-10">
      <p className="text-sm sm:text-base md:text-xs mb-4 px-2 sm:px-0">
      ...
      <p className="text-sm sm:text-base md:text-xs px-2 sm:px-0">
